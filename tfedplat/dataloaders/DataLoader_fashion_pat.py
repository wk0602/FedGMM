...
class DataLoader_fashion_pat(fp.DataLoader):
    def __init__(self,
        ...
        if balance:
            name = 'Fashion_pat_pool_' + str(pool_size) + 'item_classes_num_' + str(item_classes_num) + '_batchsize_' + str(batch_size) + '_balanced_' + '_sort_split_input_require_shape_' + str(input_require_shape)
            nickname = 'fashion pat balanced B' + str(batch_size) + ' NC'+ str(item_classes_num) + ' N' + str(pool_size)
        else:
            name = 'Fashion_pat_pool_' + str(pool_size) + 'item_classes_num_' + str(item_classes_num) + '_batchsize_' + str(batch_size) + '_unbalanced' + '_sort_split_input_require_shape_' + str(input_require_shape)
            nickname = 'fashion pat unbalanced B' + str(batch_size) + ' NC'+ str(item_classes_num) + ' N' + str(pool_size)

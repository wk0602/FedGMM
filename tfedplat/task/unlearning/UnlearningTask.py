...
class UnlearningTask(fp.BasicTask):
    ...
    def read_params(self, return_parser=False):
        ...
        parser.add_argument('--gmm_rho', help='Top-rho mask ratio for FedGMM', type=float, default=0.05)
        parser.add_argument('--gmm_mask_refresh', help='Mask refresh interval (0 means no refresh)', type=int, default=0)
        parser.add_argument('--gmm_kl_weight', help='KL-to-uniform loss weight for FedGMM', type=float, default=1.0)
        parser.add_argument('--gmm_temperature', help='Temperature for KL-to-uniform', type=float, default=1.0)
        parser.add_argument('--gmm_rho', help='Top-rho ratio for FedGMM masking', type=float, default=0.05)
        parser.add_argument('--gmm_mask_refresh', help='Mask refresh interval (0=no refresh)', type=int, default=0)
        parser.add_argument('--gmm_kl_weight', help='KL-to-uniform loss weight for FedGMM', type=float, default=1.0)
        parser.add_argument('--gmm_temperature', help='Temperature for KL-to-uniform loss', type=float, default=1.0)
